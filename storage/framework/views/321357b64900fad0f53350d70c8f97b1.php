...
<?php endif; ?>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    <?php if (isset($component)) { $__componentOriginalc295f12dca9d42f28a259237a5724830 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalc295f12dca9d42f28a259237a5724830 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.nav-link','data' => ['href' => route('upload'),'active' => request()->routeIs('upload')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('nav-link'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <div>
                    <?php if(Auth::user()->profile): ?>
                        <img src="<?php echo e(asset('images/' . Auth::user()->profile)); ?>" alt="Profile Image" width="35" class="rounded-full">
                    <?php else: ?>
...
<?php /**PATH /Users/macbookpro/Documents/Self-learn/Rean/resources/views/layouts/navigation.blade.php ENDPATH**/ ?>